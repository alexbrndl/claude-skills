...
For tracking setup, see [references/conversion-tracking.md](references/conversion-tracking.md). For GA4 and Segment instrumentation, see the analytics skill.
